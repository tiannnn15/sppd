                ...
                <div class="card-body">
                  ...
                  <form action="{{ route('tiket.store') }}" method="POST" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                          ...
                          <input type="text" class="form-control @error('kota_asal') is-invalid @enderror" name="kota_asal" value="{{ old('kota_asal') }}">
                      ...
                      <div class="form-group">
                          ...
                          <input type="text" class="form-control @error('kota_tujuan') is-invalid @enderror" name="kota_tujuan" value="{{ old('kota_tujuan') }}">
                      ...
                      <div class="form-group">
                          ...
                          <input type="text" class="form-control @error('tiket_bisnis') is-invalid @enderror" name="tiket_bisnis" value="{{ old('tiket_bisnis') }}">
                      ...
                      <div class="form-group">
                          ...
                          <input type="text" class="form-control @error('tiket_ekonomi') is-invalid @enderror" name="tiket_ekonomi" value="{{ old('tiket_ekonomi') }}">
