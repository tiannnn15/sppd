          ...
          <div class="row">
            ...
            <div class="card">
                <div class="card-body">
                  ...
                  <a href="{{ route('tiket.create') }}" class="btn btn-md btn-primary mb-3">TAMBAH DATA</a>
                  ...
                  <table class="table datatable">
                    <thead>
                      <tr>
                        ...
                        <th scope="col">Tiket Bisnis</th>
                        <th scope="col">Tiket Ekonomi</th>
                        <th scope="col">Aksi</th>
                      </tr>
                    </thead>
                    <tbody>
                        <?php $no = 1 ?>
                      @forelse ($tiket as $tiket)
                        <tr>
                            <td>{{ $no++ }}</td>
                            <td>{{ $tiket->kota_asal }}</td>
                            <td>{{ $tiket->kota_tujuan }}</td>
                            <td>{{ $tiket->tiket_bisnis }}</td>
                            <td>{{ $tiket->tiket_ekonomi }}</td>
                            <td class="text-center">
                                <form onsubmit="return confirm('Apakah Anda Yakin ?');" action="{{ route('tiket.destroy', $tiket->id) }}" method="POST">
                                    <a href="{{ route('tiket.edit', $tiket->id) }}" class="btn btn-sm btn-primary">EDIT</a>
                                    @csrf
                                    @method('DELETE')
