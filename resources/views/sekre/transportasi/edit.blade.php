      ...
      <div class="row">
        ...
        <div class="col-lg-12">
          <div class="row">
            ...
            <div class="card">
                <div class="card-body">
                  <h5 class="card-title">Edit Data Transportasi Taksi</h5>
                  ...
                  <form action="{{ route('transportasi.update', $transportasi->id) }}" method="POST" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                          ...
                          <input type="text" class="form-control @error('provinsi_id') is-invalid @enderror" name="provinsi_id" value="{{ old('provinsi_id', $transportasi->provinsi_id) }}">
                      ...
                      <div class="form-group">
                          ...
                          <input type="text" class="form-control @error('satuan') is-invalid @enderror" name="satuan" value="{{ old('satuan', $transportasi->satuan) }}">
                      ...
                      <div class="form-group">
                          <label class="font-weight-bold">Besaran</label>
                          <input type="text" class="form-control @error('besaran') is-invalid @enderror" name="besaran" value="{{ old('besaran', $transportasi->besaran) }}">
