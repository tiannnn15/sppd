    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Data Uang Harian</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
            ...
            <div class="card-body">
              ...
              <form action="{{ route('biaya.update', $biaya->id) }}" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                      ...
                      <input type="text" class="form-control @error('provinsi_id') is-invalid @enderror" name="provinsi_id" value="{{ old('provinsi_id', $biaya->provinsi_id) }}">
                  ...
                  <div class="form-group">
                      ...
                      <input type="text" class="form-control @error('satuan') is-invalid @enderror" name="satuan" value="{{ old('satuan', $biaya->satuan) }}">
                  ...
                  <div class="form-group">
                      <label class="font-weight-bold">Luar Kota</label>
                      <input type="text" class="form-control @error('luar_kota') is-invalid @enderror" name="luar_kota" value="{{ old('luar_kota', $biaya->luar_kota) }}">
                  ...
                  <div class="form-group">
                      <label class="font-weight-bold">Dalam Kota</label>
                      <input type="text" class="form-control @error('dalam_kota') is-invalid @enderror" name="dalam_kota" value="{{ old('dalam_kota', $biaya->dalam_kota) }}">
                  ...
                  <div class="form-group">
                      <label class="font-weight-bold">Diklat</label>
                      <input type="text" class="form-control @error('diklat') is-invalid @enderror" name="diklat" value="{{ old('diklat', $biaya->diklat) }}">
