      ...
      <div class="row">
        ...
        <div class="col-lg-12">
          <div class="row">
            ...
            <div class="card">
                <div class="card-body">
                  <h5 class="card-title">Data Uang Harian</h5>
                  <a href="{{ route('biaya.create') }}" class="btn btn-md btn-primary mb-3">TAMBAH DATA</a>
                  ...
                  <table class="table datatable">
                    <thead>
                      <tr>
                        ...
                        <th scope="col">Dalam Kota > 8 jam</th>
                    ...
                    <tbody>
                      ...
                      @forelse ($biaya as $biaya)
                        <tr>
                            <td>{{ $no++ }}</td>
                            <td>{{ $biaya->provinsi->nama_provinsi }}</td>
                            <td>{{ $biaya->satuan }}</td>
                            <td>{{ $biaya->luar_kota }}</td>
                            <td>{{ $biaya->dalam_kota }}</td>
                            <td>{{ $biaya->diklat }}</td>
                            <td class="text-center">
                                <form onsubmit="return confirm('Apakah Anda Yakin ?');" action="{{ route('biaya.destroy', $biaya->id) }}" method="POST">
                                    <a href="{{ route('biaya.edit', $biaya->id) }}" class="btn btn-sm btn-primary">EDIT</a>
                                    @csrf
                                    @method('DELETE')
                      ...
                      @empty
                        <div class="alert alert-danger">
                            Data Uang Harian belum Tersedia.
                        </div>
                      @endforelse
                    </tbody>
                  </table>
