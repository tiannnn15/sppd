      ...
      <div class="row">
        ...
        <div class="col-lg-12">
          <div class="row">
            ...
            <div class="card">
                <div class="card-body">
                  <h5 class="card-title">Tambah Data Uang Harian</h5>
                  ...
                  <form action="{{ route('biaya.store') }}" method="POST" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                          ...
                          <input type="text" class="form-control @error('luar_kota') is-invalid @enderror" name="luar_kota" value="{{ old('luar_kota') }}">
                      ...
                      <div class="form-group">
                          ...
                          <input type="text" class="form-control @error('dalam_kota') is-invalid @enderror" name="dalam_kota" value="{{ old('dalam_kota') }}">
                      ...
                      <div class="form-group">
                          ...
                          <input type="text" class="form-control @error('diklat') is-invalid @enderror" name="diklat" value="{{ old('diklat') }}">
