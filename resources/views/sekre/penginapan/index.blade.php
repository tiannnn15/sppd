      ...
      <div class="row">
        ...
        <div class="col-lg-12">
          <div class="row">
            ...
            <div class="card">
                <div class="card-body">
                  <h5 class="card-title">Data Penginapan</h5>
                  <a href="{{ route('penginapan.create') }}" class="btn btn-md btn-primary mb-3">TAMBAH DATA</a>
                  ...
                  <table class="table datatable">
                    ...
                    <tbody>
                      ...
                      @forelse ($penginapan as $penginapan)
                        <tr>
                            <td>{{ $no++ }}</td>
                            <td>{{ $penginapan->provinsi->nama_provinsi }}</td>
                            <td>{{ $penginapan->satuan }}</td>
                            <td>{{ $penginapan->gol_i }}</td>
                            <td>{{ $penginapan->gol_ii }}</td>
                            <td>{{ $penginapan->gol_iii }}</td>
                            <td>{{ $penginapan->gol_iv }}</td>
                            <td class="text-center">
                                <form onsubmit="return confirm('Apakah Anda Yakin ?');" action="{{ route('penginapan.destroy', $penginapan->id) }}" method="POST">
                                    <a href="{{ route('penginapan.edit', $penginapan->id) }}" class="btn btn-sm btn-primary">EDIT</a>
                                    @csrf
                                    @method('DELETE')
