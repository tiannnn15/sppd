      ...
      <div class="row">
        ...
        <div class="col-lg-12">
          <div class="row">
            ...
            <div class="card">
                <div class="card-body">
                  <h5 class="card-title">Tambah Data Penginapan</h5>
                  ...
                  <form action="{{ route('penginapan.store') }}" method="POST" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                          ...
                          <input type="text" class="form-control @error('provinsi_id') is-invalid @enderror" name="provinsi_id" value="{{ old('provinsi_id') }}">
                      ...
                      <div class="form-group">
                          ...
                          <input type="text" class="form-control @error('gol_i') is-invalid @enderror" name="gol_i" value="{{ old('gol_i') }}">
                      ...
                      <div class="form-group">
                          ...
                          <input type="text" class="form-control @error('gol_ii') is-invalid @enderror" name="gol_ii" value="{{ old('gol_ii') }}">
                      ...
                      <div class="form-group">
                          ...
                          <input type="text" class="form-control @error('gol_iii') is-invalid @enderror" name="gol_iii" value="{{ old('gol_iii') }}">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('gol_iv') is-invalid @enderror" name="gol_iv" value="{{ old('gol_iv') }}">
