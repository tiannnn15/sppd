...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <li class="nav-item">
      <a class="nav-link" href="{{ url('penginapan') }}">
  ...
  <main id="main" class="main">
    ...
    <section class="section dashboard">
      <div class="row">
        ...
        <div class="card">
            <div class="card-body">
              <h5 class="card-title">Edit Data Penginapan</h5>
              ...
              <form action="{{ route('penginapan.update', $penginapan->id) }}" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                      ...
                      <input type="text" class="form-control @error('provinsi_id') is-invalid @enderror" name="provinsi_id" value="{{ old('provinsi_id', $penginapan->provinsi_id) }}">
                  ...
                  <div class="form-group">
                      ...
                      <input type="text" class="form-control @error('satuan') is-invalid @enderror" name="satuan" value="{{ old('satuan', $penginapan->satuan) }}">
                  ...
                  <div class="form-group">
                      <label class="font-weight-bold">Golongan I</label>
                      <input type="text" class="form-control @error('gol_i') is-invalid @enderror" name="gol_i" value="{{ old('gol_i', $penginapan->gol_i) }}">
                  ...
                  <div class="form-group">
                      <label class="font-weight-bold">Golongan II</label>
                      <input type="text" class="form-control @error('gol_ii') is-invalid @enderror" name="gol_ii" value="{{ old('gol_ii', $penginapan->gol_ii) }}">
                  ...
                  <div class="form-group">
                      <label class="font-weight-bold">Golongan III</label>
                      <input type="text" class="form-control @error('gol_iii') is-invalid @enderror" name="gol_iii" value="{{ old('gol_iii', $penginapan->gol_iii) }}">
                  ...
                  <div class="form-group">
                    <label class="font-weight-bold">Golongan IV</label>
                    <input type="text" class="form-control @error('gol_iv') is-invalid @enderror" name="gol_iv" value="{{ old('gol_iv', $penginapan->gol_iv) }}">
