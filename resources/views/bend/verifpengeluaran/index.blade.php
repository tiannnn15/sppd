      ...
      <div class="row">
        ...
        <div class="col-lg-12">
            <div class="row">
              ...
              <div class="card">
                  <div class="card-body">
                    <h5 class="card-title">Verifikasi Pengeluaran</h5>
                    ...
                    <table class="table datatable">
                      ...
                      <tr>
                        ...
                        <td>
                            <a href="{{ route('verifpengeluaran.show', $item->id) }}" class="btn btn-sm btn-primary">SHOW</a>
                            <a href="{{ url('approv', $item->id) }}" class="btn btn-sm btn-success">TERIMA</a>
                            <a href="{{ url('cancel', $item->id) }}" class="btn btn-sm btn-danger">TOLAK</a>
                        </td>
                      </tr>
                      @endforeach
                      </tbody>
