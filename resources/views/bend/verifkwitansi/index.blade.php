      ...
      <div class="row">
        ...
        <div class="col-lg-12">
            <div class="row">
              ...
              <div class="card">
                  <div class="card-body">
                    <h5 class="card-title">Verifikasi Kwitansi</h5>
                    ...
                    <table class="table datatable">
                      ...
                      <tbody>
                        ...
                        <td>
                                <a href="{{ route('verifkwitansi.show', $item->id) }}" class="btn btn-sm btn-primary">SHOW</a>
                                <a href="{{ url('approve', $item->id) }}" class="btn btn-sm btn-success">TERIMA</a>
                                <a href="{{ url('disapprove', $item->id) }}" class="btn btn-sm btn-danger">TOLAK</a>
                        </td></tr>
                        @endforeach
                      </tbody>
                    </table>
