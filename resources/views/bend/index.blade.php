...
@php
    ...
    if (\App\Models\Kwitansi::whereNotNull('status_perjalanan')->orderBy('id', 'DESC')) {
        $kwi = \App\Models\Kwitansi::whereNotNull('status_perjalanan')->orderBy('id', 'DESC')->count();
    }
...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link" href="{{ url('bend') }}">
        ...
        <div class="col-lg-12">
          <div class="row">
            ...
            <div class="col-xxl-3 col-md-6">
              <div class="card info-card sales-card">
                <div class="card-body">
                  <h5 class="card-title">Total Verif Laporan</h5>
            ...
            <div class="col-xxl-3 col-md-6">
              <div class="card info-card sales-card">
                <div class="card-body">
                  <h5 class="card-title">Total Verif Kwitansi</h5>
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <h6>
                        <span data-counter="counterup" data-value="7800">{{ $kwi }}</span>
                        <small class="font-green-sharp"></small>
                      </h6>
                    </div>
                  </div>
            ...
            <div class="col-xxl-3 col-md-6">
              <div class="card info-card sales-card">
                <div class="card-body">
                  <h5 class="card-title">Total Verif Pengeluaran</h5>
