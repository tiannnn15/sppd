...
@php
    ...
    if (\App\Models\Disposisi::whereYear('tgl_diterima', date('Y'))->orderBy('id', 'DESC')) {
        $disposisi = \App\Models\Disposisi::whereYear('tgl_diterima', date('Y'))->orderBy('id', 'DESC')->count();
    }
          ...
          <div class="row">
            ...
            <div class="col-xxl-3 col-md-6">
              <div class="card info-card sales-card">
                <a href="{{ url('listsuratmasuk') }}">
                <div class="card-body">
                  <h5 class="card-title">Surat Masuk <span>| Selengkapnya</span></h5>
            ...
            <div class="col-xxl-3 col-md-6">
              <div class="card info-card sales-card">
                <div class="card-body">
                  <h5 class="card-title">Total Verif SPPD</h5>
