...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link" href="{{ url('verifsppd') }}">
                    ...
                    <tbody>
                      ...
                      @forelse ($sppd as $sppd)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('verifsppd.show', $sppd->id) }}" class="btn btn-sm btn-primary">SHOW</a>
                                <a href="{{ url('terima', $sppd->id) }}" class="btn btn-sm btn-success">TERIMA</a>
                                <a href="{{ url('tolak', $sppd->id) }}" class="btn btn-sm btn-danger">TOLAK</a>
                            </td>
                        </tr>
                      @empty
