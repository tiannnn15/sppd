          ...
          <div class="row">
            ...
            <div class="card">
                <div class="card-body">
                  ...
                  <a href="{{ route('disposisi.create') }}" class="btn btn-md btn-primary mb-3">BUAT DISPOSISI</a>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <form onsubmit="return confirm('Apakah Anda Yakin ?');" action="{{ route('disposisi.destroy', $disposisi->id) }}" method="POST">
                                    <a href="{{ route('disposisi.show', $disposisi->id) }}" class="btn btn-sm btn-primary">SHOW</a>
                                    {{--  <a href="{{ route('disposisi.edit', $disposisi->id) }}" class="btn btn-sm btn-primary">EDIT</a>  --}}
                                    @csrf
                                    @method('DELETE')
