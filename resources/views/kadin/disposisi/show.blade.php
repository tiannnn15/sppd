                ...
                <div class="card-body">
                  ...
                  <div class="invoice">
                    <table class="table table-bordered" width="100%">
                      <tbody>
                        <tr>
                          <td class="text-center" colspan="2"><strong>LEMBAR DISPOSISI</strong></td>
                        </tr>
                        <tr>
                          <td>
                            Surat Dari : {{ $disposisi->suratmasuk->instansi_pengirim }}<br>
                            <br>
                            No. Surat : {{ $disposisi->suratmasuk->nomer_surat_masuk }}<br>
                            Tgl. Surat : {{ $disposisi->suratmasuk->tgl_surat_masuk }}
                          </td>
                          <td>
                            Diterima Tgl. : {{ $disposisi->tgl_diterima }}<br>
                            No. Agenda : {{ $disposisi->nomer_agenda }}<br>
                            Sifat : {{ $disposisi->sifat_surat }}<br>
                            <br>
                          </td>
                        </tr>
                        <tr>
                          <td colspan="2">Hal : {{ $disposisi->hal_surat }}</td>
                        </tr>
                        <tr>
                          <td>Diteruskan Kepada : {{ $disposisi->pegawai->nama_pegawai }} <br> {{ $disposisi->pengikut }}<br></td>
                          <td>Dengan hormat harap : {{ $disposisi->urgensi_surat }}<br></td>
                        </tr>
                        <tr>
                          <td colspan="2">Catatan : {{ $disposisi->catatan_disposisi }}</td>
                        </tr>
                        <tr>
                          <td></td>
                          <td colspan="2" class="text-center">
                            KEPALA DINAS LINGKUNGAN HIDUP <br>
                            Nganjuk, {{ $disposisi->tgl_disposisi }} <br>
                            <br>
                            SUBANI, SH. MM
                          </td>
                        </tr>
