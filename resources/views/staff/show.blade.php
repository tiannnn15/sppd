                  ...
                  <table class="table table-bordered" width="100%">
                    <tbody>
                      <tr>
                        ...
                        <td>
                          Surat Dari : {{ $item->instansi_pengirim }}<br>
                          <br>
                          No. Surat : {{ $item->tgl_disposisi }}<br>
                          Tgl. Surat : {{ $item->tgl_surat_masuk }}
                        </td>
                        <td>
                          Diterima Tgl. : {{ $item->tgl_diterima }}<br>
                          No. Agenda : {{ $item->nomer_agenda }}<br>
                          Sifat : {{ $item->sifat_surat }}<br>
                          <br>
                        </td>
                      </tr>
                      <tr>
                        <td colspan="2">Hal : {{ $item->hal_surat }}</td>
                      </tr>
                      <tr>
                        <td>Diteruskan Kepada : {{ $item->nama_pegawai }}<br>{{ $item->pengikut }}</td>
                        <td>Dengan hormat harap : {{ $item->urgensi_surat }}<br></td>
                      </tr>
                      <tr>
                        <td colspan="2">Catatan : {{ $item->catatan_disposisi }}</td>
                      </tr>
                      <tr>
                        <td></td>
                        <td colspan="2" class="text-center">
                          KEPALA DINAS LINGKUNGAN HIDUP <br>
                          Nganjuk, {{ $item->tgl_disposisi }} <br>
                          <br>
                          SUBANI, SH. MM
                        </td>
                      </tr>
