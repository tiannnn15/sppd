          ...
          <div class="row">
            ...
            <div class="card">
                <div class="card-body">
                  ...
                  <a href="{{ route('kwitansi.create') }}" class="btn btn-md btn-primary mb-3">TAMBAH DATA</a>
                  ...
                  <table class="table datatable">
                    ...
                    <tbody>
                      ...
                      {{--  <td>{{ $item->banyaknya_uang }}</td>  --}}
                      <td><span class="badge bg-{{ ($item->status == 'approve' ? 'primary' : ($item->status == 'disapprove' ? 'danger' : ($item->status == 'Mengajukan' ? 'warning' : ''))) }}">{{ $item->status }}</span></td>
                      <td class="text-center">
                        <a href="{{ route('kwitansi.show', $item->id) }}" class="btn btn-sm btn-primary">SHOW</a>
                        <a href="{{ route('kwitansi.edit', $item->id) }}" class="btn btn-sm btn-warning">EDIT</a>
                        <form onsubmit="return confirm('Apakah Anda Yakin ?');" action="{{ route('kwitansi.destroy', $item->id) }}" method="POST" class="d-inline">
                        @csrf
                              @method('DELETE')
