          ...
          <div class="row">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('kwitansi.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group mt-2">
                      ...
                      <div class="form-group mt-2">
                        ...
                        <input type="text" class="form-control @error('no_kas') is-invalid @enderror" name="no_kas" value="{{ old('no_kas') }}">
                      ...
                      <div class="form-group mt-2">
                        ...
                        <input type="text" class="form-control @error('kode_rekening') is-invalid @enderror" name="kode_rekening" value="{{ old('kode_rekening') }}">
                      ...
                      <div class="form-group mt-2">
                        ...
                        <input type="text" class="form-control @error('terima_dari') is-invalid @enderror" name="terima_dari" value="{{ old('terima_dari') }}">
                      ...
                      <div class="form-group mt-2">
                        ...
                        <input type="text" class="form-control @error('banyaknya_uang') is-invalid @enderror" name="banyaknya_uang" value="{{ old('banyaknya_uang') }}">
                      ...
                      <div class="form-group mt-2">
                        ...
                        <input type="text" class="form-control @error('untuk_pembayaran') is-invalid @enderror" name="untuk_pembayaran" value="{{ old('untuk_pembayaran') }}">
                      ...
                      <div class="form-group mt-2">
                        ...
                        <select class="form-control @error('status_perjalanan') is-invalid @enderror" name="status_perjalanan" value="{{ old('status_perjalanan') }}">
