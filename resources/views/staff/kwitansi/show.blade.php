                        ...
                        <div class="invoice">
                            ...
                            <div>
                                <table class="table table-bordered" width="100%">
                                  ...
                                  <tbody>
                                    <tr>
                                        <td>1.</td>
                                        <td>{{ $kwitansi->sppd->pelaksana->pegawai->nama_pegawai }}</td>
                                        <td>{{ $kwitansi->sppd->tempat_tujuan }}</td>
                                        <td>{{ date("d-m-Y", strtotime($kwitansi->sppd->tgl_sppd)) }}</td>
                                        <td> {{ $kwitansi->sppd->lama_perjalanan }} Hari x  {{  number_format((int)$kwitansi->rincian, 0, ',', '.') }}
                                        </td>
                                        <td>
                            ...
                            <div class="row mb-4">
                                <div class="col-lg-4 text-center">
                                    ...
                                    <br>
                                    <br>
                                    <b><u>SUBANI, SH, MM</u></b><br>
                                    NIP. 19691005 198903 1 007
                                </div>
                                <div class="col-lg-4 text-center">
                                    Menyetujui
                                    <br>
