          ...
          <div class="row">
            ...
            <div class="card">
                <div class="card-body">
                  ...
                  <a href="{{ route('laporan.create') }}" class="btn btn-md btn-primary mb-3">TAMBAH DATA</a>
                      ...
                      @forelse ($laporan as $item)
                        <tr>
                            ...
                            <td class="text-center">
                                <form onsubmit="return confirm('Apakah Anda Yakin ?');" action="{{ route('laporan.destroy', $item->id) }}" method="POST">
                                    <a href="{{ route('laporan.show', $item->id) }}" class="btn btn-sm btn-primary">SHOW</a>
