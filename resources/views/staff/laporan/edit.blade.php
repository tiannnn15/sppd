                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('laporan.update', $laporan->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label class="font-weight-bold">Id SPPD</label>
                            <input type="text" class="form-control @error('sppd_id') is-invalid @enderror" id="sppd_id" name="sppd_id" value="{{ $laporan->sppd_id }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('landasan') is-invalid @enderror" name="landasan" value="{{ $laporan->landasan }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('maksud_tujuan') is-invalid @enderror" name="maksud_tujuan" value="{{ $laporan->maksud_tujuan }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('kegiatan') is-invalid @enderror" name="kegiatan" value="{{ $laporan->kegiatan }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('perihal') is-invalid @enderror" name="perihal" value="{{ $laporan->perihal }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('kesimpulan') is-invalid @enderror" name="kesimpulan" value="{{ $laporan->kesimpulan }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control @error('tgl_laporan') is-invalid @enderror" name="tgl_laporan" value="{{ $laporan->tgl_laporan }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('penutup') is-invalid @enderror" name="penutup" value="{{ $laporan->penutup }}">
                        ...
                        <div class="mt-3"><img src="{{ asset($laporan->gambar) }}" id="output" width="500"></div>
