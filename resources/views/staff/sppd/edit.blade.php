                ...
                <div class="card-body">
                    ...
                    @csrf
                      <div class="form-group mt-2">
                          ...
                          <input type="text" class="form-control" name="nomer_sppd" value="{{  $sppd->nomer_sppd }}" readonly>
                      ...
                      <div class="form-group mt-2">
                        ...
                        <input type="text" class="form-control @error('lembar_ke') is-invalid @enderror" name="lembar_ke" value="{{ old('lembar_ke', $sppd->lembar_ke) }}">
                      ...
                      <div class="form-group mt-2">
                        ...
                        <input type="text" class="form-control @error('kode_no') is-invalid @enderror" name="kode_no" value="{{ old('kode_no', $sppd->kode_no) }}">
                      ...
                      <div class="form-group mt-2">
                        ...
                        <input type="text" class="form-control @error('maksud_perjalanan') is-invalid @enderror" name="maksud_perjalanan" value="{{ old('maksud_perjalanan', $sppd->maksud_perjalanan) }}">
                      ...
                      <div class="form-group mt-2">
                        ...
                        <input type="text" class="form-control @error('alat_angkut') is-invalid @enderror" name="alat_angkut" value="{{ old('alat_angkut', $sppd->alat_angkut) }}">
                      ...
                      <div class="form-group mt-2">
                        ...
                        <select class="form-control selectpicker border border-dark" required name="provinsi" id="provinsi"data-size="5" data-live-search="true" title="Pilih Provinsi Tempat Tujuan">
                          @foreach ($provinsi as $item)
                            @if (old('provinsi', $sppd->provinsi_id) == $item->id)
                      ...
                      <div class="form-group mt-2">
                        ...
                        <input type="text" class="form-control @error('tempat_tujuan') is-invalid @enderror" name="tempat_tujuan" value="{{ old('tempat_tujuan', $sppd->tempat_tujuan) }}">
                      ...
                      <div class="form-group mt-2">
                        ...
                        <input type="number" class="form-control @error('lama_perjalanan') is-invalid @enderror" name="lama_perjalanan" value="{{ old('lama_perjalanan', $sppd->lama_perjalanan) }}">
                        ...
                        <div class="form-group mt-2">
                            ...
                            <input type="date" class="form-control @error('tgl_berangkat') is-invalid @enderror" name="tgl_berangkat" value="{{ old('tgl_berangkat', $sppd->tgl_berangkat) }}">
                        ...
                        <div class="form-group mt-2">
                            ...
                            <input type="date" class="form-control @error('tgl_kembali') is-invalid @enderror" name="tgl_kembali" value="{{ old('tgl_kembali', $sppd->tgl_kembali) }}">
                        ...
                        <div class="form-group mt-2">
                          ...
                          <select class="form-control selectpicker border border-border-dark" required name="pelaksana" id="pelaksana"data-size="5" data-live-search="true" title="Pilih Pegawai Pelaksana">
                            @foreach ($pegawai as $item)
                              @if ($sppd->pelaksana->pegawai_id == $item->id)
                       ...
                       <div class="form-group mt-2">
                        ...
                        <select class="form-control selectpicker border border-dark" required name="pengikut[]" id="pengikut" data-prefix="Pegawai Pendamping: " multiple="multiple" data-size="5" data-live-search="true" title="Pilih Pegawai Pendamping" >
                          @foreach ($pegawai as $item)
                            @if (in_array($item->id, $pendamping))
                              <option value="{{ $item->id }}" selected="selected">{{ $item->nama_pegawai }}</option>
                            @else
                              <option value="{{ $item->id }}">{{ $item->nama_pegawai }}</option>
                            @endif
                        ...
                        <div class="form-group mt-2">
                            ...
                            <input type="date" class="form-control @error('tgl_sppd') is-invalid @enderror" name="tgl_sppd" value="{{ old('tgl_sppd', $sppd->tgl_sppd) }}">
                        ...
                        <div class="form-group mt-2">
                            ...
                            <input type="text" class="form-control @error('dasar') is-invalid @enderror" name="dasar" value="{{ old('dasar', $sppd->dasar) }}">
